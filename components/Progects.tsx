...
const Progects: FC<myProps> = ({ darkThemeBtn }) => {
  useEffect(() => {
    setInterval(() => {
      getNuxt('https://resume-fd.herokuapp.com/posts/nuxt').then(data => setNuxtComments(data))
  ...
  const postMebelbestСomments = async () => {
    ...
    getMebelbest('https://resume-fd.herokuapp.com/posts/mebelbest').then(data => setNuxtComments(data))
  }
          ...
          <div className="section-progects__item-2__container__description">
            <div className="section-progects__item-2__container__description__inner">
              ...
              <div className={!darkThemeBtn ? "section-progects__item-2__container__description__inner__subtitle" : "section-progects__item-2__container__description__inner__subtitle dark-theme"}>
                Сайт выполнен на фреймворке Nuxt JS. В данном проекте<br/>
                реализован поиск, изменение состояния кнопок.<br/>
                Webpack и tsc настроил самостоятельно.
              </div>
              <div className="section-progects__item__description__comments">
                <h3 className={!darkThemeBtn ? "section-progects__item__description__comments__title" : "section-progects__item__description__comments__title dark-theme"}>
                  Комментарии
                </h3>
                ...
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-name" : "section-progects__item__description__comments__input-name dark-theme"} type="text" placeholder="Введите свое имя" value={nuxtName} onChange={(e) => setNuxtName(e.target.value)} />
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-text" : "section-progects__item__description__comments__input-text dark-theme"} type="text" placeholder="Введите текст комментария" value={nuxtText} onChange={(e) => setNuxtText(e.target.value)} />
                <button className={!darkThemeBtn ? "section-progects__item__description__comments__button" : "section-progects__item__description__comments__button dark-theme"} onClick={postNuxtСomments}>Отправить</button>
              </div>
            </div>
          </div>
                  ...
                  <div className="card__body">
                    ...
                    <button>
                      <motion.div
                        ...
                        whileTap={{ scale: 1.2 }}
                      >
                        <a className={!darkThemeBtn ? "card__body__link-1" : "card__body__link-1 dark-theme"} href="https://nuxt-st.herokuapp.com/">Перейти на сайт</a>
                      </motion.div>
                    </button>
                    <button>
                      <motion.div
                        ...
                        whileTap={{ scale: 1.2 }}
                      >
                        <a className={!darkThemeBtn ? "card__body__link-2" : "card__body__link-2 dark-theme"} href="https://github.com/ConstantineAB/nuxt-store">Исходный код</a>
                      </motion.div>
                    </button>
                  </div>
                </div>
          ...
          <div className="section-progects__item__description__inner">
            ...
            <div className={!darkThemeBtn ? "section-progects__item__description__inner__subtitle" : "section-progects__item__description__inner__subtitle dark-theme"}>
              ...
              <div className="section-progects__item__description__comments">
                ...
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-name" : "section-progects__item__description__comments__input-name dark-theme"} type="text" placeholder="Введите свое имя" value={perekrestokName} onChange={(e) => setPerekrestokName(e.target.value)} />
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-text" : "section-progects__item__description__comments__input-text dark-theme"} type="text" placeholder="Введите текст комментария" value={perekrestokText} onChange={(e) => setPerekrestokText(e.target.value)} />
                <button className={!darkThemeBtn ? "section-progects__item__description__comments__button" : "section-progects__item__description__comments__button dark-theme"} onClick={postPerekrestokСomments}>Отправить</button>
              </div>
          </div>
        </div> 
      </div>
          ...
          <div className="section-progects__item-2__container__description">
            <div className="section-progects__item-2__container__description__inner">
              ...
              <div className="section-progects__item__description__comments">
                ...
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-name" : "section-progects__item__description__comments__input-name dark-theme"} type="text" placeholder="Введите свое имя" value={landingName} onChange={(e) => setLandingName(e.target.value)} />
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-text" : "section-progects__item__description__comments__input-text dark-theme"} type="text" placeholder="Введите текст комментария" value={landingText} onChange={(e) => setLandingText(e.target.value)} />
                <button className={!darkThemeBtn ? "section-progects__item__description__comments__button" : "section-progects__item__description__comments__button dark-theme"} onClick={postLandingСomments}>Отправить</button>
              </div>
            </div>
          </div>
          <div onClick={() => useCard2(!card2)} className="card">
        ...
        <div className="section-progects__item__description">
          <div className="section-progects__item__description__inner">
            ...
            <div className="section-progects__item__description__comments">
              ...
              <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-name" : "section-progects__item__description__comments__input-name dark-theme"} type="text" placeholder="Введите свое имя" value={mebelName} onChange={(e) => setMebelName(e.target.value)} />
              <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-text" : "section-progects__item__description__comments__input-text dark-theme"} type="text" placeholder="Введите текст комментария" value={mebelText} onChange={(e) => setMebelText(e.target.value)} />
              <button className={!darkThemeBtn ? "section-progects__item__description__comments__button" : "section-progects__item__description__comments__button dark-theme"} onClick={postMebelСomments}>Отправить</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="section-progects__item-2__container__description">
            <div className="section-progects__item-2__container__description__inner">
              ...
              <div className="section-progects__item__description__comments">
                ...
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-name" : "section-progects__item__description__comments__input-name dark-theme"} type="text" placeholder="Введите свое имя" value={mebelbestName} onChange={(e) => setMebelbestName(e.target.value)} />
                <input className={!darkThemeBtn ? "section-progects__item__description__comments__input-text" : "section-progects__item__description__comments__input-text dark-theme"} type="text" placeholder="Введите текст комментария" value={mebelbestText} onChange={(e) => setMebelbestText(e.target.value)} />
                <button className={!darkThemeBtn ? "section-progects__item__description__comments__button" : "section-progects__item__description__comments__button dark-theme"} onClick={postMebelbestСomments}>Отправить</button>
              </div>
            </div>
          </div>
